...
function e(b) {
  switch (b) {
    ...
    case 37: // rainbow baby bro
      return T(
        [l.red, l.blue][Math.floor((Date.now() / 200) % 6)],
        [l.blue, l.red][Math.floor((Date.now() / 200) % 6)],
        (Date.now() / 200) % 1
      );
...
//background: linear-gradient(#000000, #8800C7); purple to black color gradient